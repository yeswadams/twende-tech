...
const WhyTwendeTech = () => {
  return (
    <section className="py-16">
      ...
      <h2 className='text-2xl font-bold text-black text-center mb-12'>Why TwendeTech?</h2>
      <h1 className='text-4xl font-bold text-black text-center mb-12'>Your Path to a Tech Career Start Here.</h1>
      <p className='text-gray-600'>TwendeTech is designed to help Kenyan youth, students, and early-career professionals access and excel <br/> in sought-after tech careers.</p>
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 my-4">
        <div className="flex flex-col items-start text-left px-6 py-8 bg-white rounded-lg border-2 border-gray-300">
          ...
          <p className='text-black'>Content tailored to the Kenyan job market.</p>
        </div>
        <div className="flex flex-col items-start text-left px-6 py-8 bg-white rounded-lg border-2 border-gray-300">
          {/* Placeholder Icon */}
          <div className="icon-placeholder">
        ...
        <div className="flex flex-col items-start text-left px-6 py-8 bg-white rounded-lg border-2 border-gray-300">
          ...
          <p className='text-black'>Get tailored recommendations based on your unique profile.</p>
        </div>
        <div className="flex flex-col items-start text-left px-6 py-8 bg-white rounded-lg border-2 border-gray-300">
          <div className="icon-placeholder">
          ...
          <p className='text-black'>No cost to access resources and empowering your journey.</p>
        </div>
      </div>
      </div>
    </section>
